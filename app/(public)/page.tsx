...
const features: featureProps[] = [
  ...
  },
  {
    ...
    description:
      "Engage with interactive content, quizzes, and assignments to enhance your learning experence.",
    icon: "🎮",
  },
  {
    ...
    <>
      <section className="relative py-20 ">
        <div className="flex flex-col items-center text-center space-y-8 ">
          <Badge variant="outline">The Future of Online Educatin</Badge>
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight   ">
            Elevate your Learning Experience
          </h1>
          <p className="max-w-[700px] text-muted-foreground md:text-xl">
            Discover a new wy to learn with our modern, interactive larning
            managment system. Acces high-quality courses anytime, anywer.
          </p>
