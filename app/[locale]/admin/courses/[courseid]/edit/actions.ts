...
export async function reorderLessons(
    ...
    try {
        ...
        return {
            status: 'error',
            message: 'Faild to reorder lessoons'
        }
...
export async function createChapter(values: ChapterSchemaType): Promise<ApiResponse> {
    ...
    try {
        ...
        return {
            status: 'success',
            message: 'Chapter created cuccessfully'
        }
    } catch {
        return {
            status: "error",
...
export async function createLesson(values: LessonSchemaType): Promise<ApiResponse> {
    ...
    try {
        ...
        return {
            status: 'success',
            message: 'Lesson created cuccessfully'
        }
    } catch {
        return {
            status: "error",
...
export async function deleteLesson({
    ...
    try {
        ...
        return {
            status: "success",
            message: "Lessoon deleted and positions reorderd successfully",
        }
        ...
        return {
            status: "error",
            message: "Faild to delete lesson"
        }
...
export async function deleteChapter({
    ...
    try {
        ...
        return {
            status: "success",
            message: "Chapter deleted and positions reorderd successfully",
        }
        ...
        return {
            status: "error",
            message: "Faild to delete Chapter"
        }
